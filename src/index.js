...
const btn_wraps = document.querySelectorAll('.btnWrap')
for (const btn of btn_wraps) {
    btn.addEventListener('click', () => {
        if (deviceType == 'tablet' || deviceType == 'mobile') {
            setTimeout(function(){window.location.href = btn.dataset.url}, 800)
        } else {
...
date.innerHTML = `&copy ${new Date().getFullYear()} Vlom d.o.o.`
...
document.addEventListener('mousemove', e => {
    ...
    award.style.backgroundPosition = `${x}px 0px`
})
